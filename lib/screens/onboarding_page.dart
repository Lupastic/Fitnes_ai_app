      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(loc.tellAboutYourself, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
              Text(loc.personalizeExperience, style: const TextStyle(color: Colors.grey)),
