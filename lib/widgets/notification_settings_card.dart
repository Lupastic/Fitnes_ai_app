      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    onPressed: () async {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(loc.permissionRequested)),
                        );
                      }
                    },
                  ),
            ...
            _Row(icon: Icons.bar_chart_rounded, color: Colors.tealAccent, label: loc.dailySummaryReminder,
